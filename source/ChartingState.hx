...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addAboutUI():Void
	{
		var tab_group_about = new FlxUI(null, UI_box);
		tab_group_about.name = 'About';

		var titleText = new FlxUIText(10, 10, 10, "Test"); // I dont knowd

		tab_group_about.add(titleText);
	}
	...
	function addNoteUI():Void
	{
		...
		writingNotesText = new FlxUIText(20, 100, 0, "Test");
