...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-car': // not on heavy speaker that isnt held up pog
			...
			case 'chair':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('chair');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
			...
			case 'imposter':
				// SUS
				tex = Paths.getSparrowAtlas('IMPOSTER');
				frames = tex;
				animation.addByPrefix('idle', 'Sus idle dance', 24);
				animation.addByPrefix('singUP', 'Sus Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Sus Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'Sus Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'Sus Sing Note LEFT', 24);
			...
			case 'spookyplaceholder':
				tex = Paths.getSparrowAtlas('spooky_placeholder');
				frames = tex;
				animation.addByPrefix('singUP', 'spooky UP NOTE', 24, false);
				animation.addByPrefix('singDOWN', 'spooky DOWN note', 24, false);
				animation.addByPrefix('singLEFT', 'note sing left', 24, false);
			...
			case 'neil': // Maybe this will fix the broken song?
				tex = Paths.getSparrowAtlas('neil');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
			...
			case 'krabs':
				var tex = Paths.getSparrowAtlas('KRABS');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'crumb': // cat
				var tex = Paths.getSparrowAtlas('crumb');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
